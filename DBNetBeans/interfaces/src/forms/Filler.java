...
public class Filler extends javax.swing.JFrame {
    ...
    public Filler() {
        initComponents();
        this.setTitle("Dato Empleado");
        this.setLocationRelativeTo(null);
        String[] nacionalidades = {"Colombiano", "Peruano", "Ecuatoriano"};
        String[] generos = {"Femenino","Masculino"};
        String[] estadosCiviles = {"Soltero","Casado"};
        
        for(String dato:nacionalidades){
            cmbNacionalidad.addItem(dato);
        }
        for(String dato:generos){
            cmbGenero.addItem(dato);
        }
        for(String dato:estadosCiviles){
            cmbEstadoCivil.addItem(dato);
        }
    }
    ...
    private void initComponents() {
        ...
        txaDatos = new javax.swing.JTextField();
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(cmbNacionalidad, 0, 122, Short.MAX_VALUE))
                            .addComponent(jLabel)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cmbEstadoCivil, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        objEmpleado.setDocumento(txtDocumento.getText());
        objEmpleado.setNombre(txtNombre.getText());
        objEmpleado.setApellido(txtApellido.getText());
        objEmpleado.setNacionalidad(cmbNacionalidad.getSelectedItem().toString());
        objEmpleado.setGenero(cmbGenero.getSelectedItem().toString());
        objEmpleado.setEstadoCivil(cmbEstadoCivil.getSelectedItem().toString());
        txaDatos1.setText(objEmpleado.agregarEmpleado());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Filler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txaDatos;
